...
Downgrade ONLY for coin-specific red flags such as: 24h move already overextended (>15%), volume shock extreme relative to the move (>8x on <5% gain — manipulation pattern), negative or barely-positive RS/BTC (pure beta, no alpha), price at round-number resistance, or GPT confidence clearly unjustified by the numbers shown.
