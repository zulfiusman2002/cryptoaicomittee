...
async function runScan({ waitForWrites = false, source = 'manual' } = {}) {
  ...
  // ── Step 1: market data + evaluate open paper trades in parallel ─
  ...
  console.log(`[scan:${source}] Paper: ${paperEval.evaluated} evaluated, ${paperEval.closed} closed. Data:`, JSON.stringify(diagnostics))
